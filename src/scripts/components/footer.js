...
class FooterArea extends HTMLElement {
  ...
  render() {
    ...
    >
      <div
        class="m-auto flex max-w-270 flex-col items-start justify-center gap-6 md:flex-row"
      >
        <div class="max-w-100">
      ...
      <p
        class="pointer-events-none absolute bottom-0 left-0 w-full translate-y-[45%] text-center text-7xl leading-none font-semibold whitespace-nowrap opacity-20 select-none md:text-[160px]"
      >
        Storiy Board
      </p>
    </footer>`;
